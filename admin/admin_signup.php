                ...
                <div class="sect">
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 col-md-9 col-sm-8 mt-4">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <p>admin register form</p>
                                        <?php
                                            $qry = mysqli_query($conn, "SELECT * FROM tbl_user");
                                            $count = mysqli_num_rows($qry);
                                            if ($count > 0) {
                                                ?>
                                                    <div class="right-btns">
                                                        <a href="index.php" class="btn btn-sm" id="btnrecent"><i class="fas fa-sign-in"></i>  Login</a>
                                                    </div>
                                                <?php
                                            }
                                        ?>
                                            ...
                                            <div class="form-group" id="grp">
                                                <div class="row">
                                                    <div class="col-md-12 mb-4">
                                                        ...
                                                        <input type="text" name="phone" id="" placeholder="07XXXXXXXX">
                                                    </div>
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary btn-sm" name="add_user">REGISTER</button>
