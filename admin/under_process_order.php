...
<head>
    ...
    <title>Restaurant || Under Processed Orders</title>
        ...
        <div class="container-fluid">
            <div class="section-header">
                <div class="headers">
                    ...
                    <p>/</p>
                    <p>View Under Processed Orders</p>
                </div>
            </div>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    <p>under processed orders info</p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover text-center" id="tbl">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Omar Mathias</td>
                                <td>0745711293</td>
                                <td><span class="badge bg-success">Under Proccess</span></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>RST456734</td>
