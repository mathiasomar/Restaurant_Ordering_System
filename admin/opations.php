...
<head>
    ...
    <title>Restaurant || Manage Options</title>
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <div class="right-btns">
                        <a href="add_option.html" class="btn btn-sm" id="btnrecent"><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-responsive table-striped table-bordered table-hover text-center" id="tbl">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="edit_option.html" class="badge bg-success"><i class="fas fa-edit"></i></a>
                                    <a href="#" class="badge bg-danger"><i class="fas fa-trash-alt"></i></a>
                                    <a href="#" class="badge bg-primary">Activate</a>
                                </td>
                            </tr>
                            <tr>
                                <td>Extra Large</td>
